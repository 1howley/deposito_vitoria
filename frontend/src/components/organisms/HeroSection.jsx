...
export function HeroSection({ onShopNow }) {
  const handleConsultorClick = () => {
    ...
    const message = "Olá! Gostaria de falar com um consultor sobre materiais de construção.";
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-6 md:mb-8 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent leading-tight">
            ...
            <span className="block text-foreground">de Qualidade</span>
          </h1>

          <p className="text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
            Transforme sua obra com nossos materiais de construção selecionados.
            Qualidade garantida, atendimento especializado e resultados excepcionais.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-12 md:mb-16 px-4">
            <Button size="lg" onClick={onShopNow} className="group h-12 md:h-14 px-6 md:px-8 rounded-full text-base md:text-lg">
              Explorar Catálogo
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center p-4 md:p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-border/50">
              ...
              <h3 className="font-semibold mb-2 text-sm md:text-base">Qualidade Certificada</h3>
              <p className="text-muted-foreground text-xs md:text-sm text-center">Produtos com certificação de qualidade</p>
            </div>
            ...
            <div className="flex flex-col items-center p-4 md:p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-border/50">
              ...
              <h3 className="font-semibold mb-2 text-sm md:text-base">Atendimento 5 Estrelas</h3>
              <p className="text-muted-foreground text-xs md:text-sm text-center">Consultoria especializada para sua obra</p>
            </div>
            ...
            <div className="flex flex-col items-center p-4 md:p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-border/50">
              ...
              <h3 className="font-semibold mb-2 text-sm md:text-base">Garantia Total</h3>
              <p className="text-muted-foreground text-xs md:text-sm text-center">Garantia completa em todos os produtos</p>
            </div>
          </div>
        </div>
      </div>

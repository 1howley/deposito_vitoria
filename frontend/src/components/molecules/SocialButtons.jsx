...
const SocialButtons = () => {
    ...
    const handleFacebookClick = () => {
        window.open('https://www.facebook.com/depositojardimvitoria/', '_blank');
    };

    const handleInstagramClick = () => {
        window.open('https://www.instagram.com/depositovitoriacajuru/', '_blank');
    };
    ...
    return (
        <div className="flex gap-2">
            ...
            <Button variant="outline" size="icon" onClick={handleInstagramClick}>

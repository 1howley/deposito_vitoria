...
import { Search, Grid, List, ArrowLeft, Paintbrush, TrendingUp, Star, Filter } from "lucide-react";
...
export function PaintsPage({ onAddToCart, onBack }) {
  ...
  const paintsProducts = [
    // Tintas Internas
    {
      ...
      description: "Tinta acrílica lavável de alta cobertura para ambientes internos",
      inStock: true,
      rating: 4.9,
      bestseller: true
    },
  ...
  const subcategories = [
    ...
    { id: "Tintas Internas", name: "Tintas Internas", count: paintsProducts.filter(p => p.subcategory === "Tintas Internas").length },
    { id: "Tintas Externas", name: "Tintas Externas", count: paintsProducts.filter(p => p.subcategory === "Tintas Externas").length },
    { id: "Complementos", name: "Complementos", count: paintsProducts.filter(p => p.subcategory === "Complementos").length },
    { id: "Acessórios", name: "Acessórios", count: paintsProducts.filter(p => p.subcategory === "Acessórios").length }
  ];
  ...
  const filteredProducts = paintsProducts.filter(product => {
    ...
    if (priceRange === "50to150") matchesPrice = product.price >= 50 && product.price <= 150;
        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl">Tintas e Pintura</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <Select value={priceRange} onValueChange={setPriceRange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="over150">Acima de R$ 150</SelectItem>
            </SelectContent>
          </Select>

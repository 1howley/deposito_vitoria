...
import {
    ...
    SelectTrigger,
    SelectValue,
} from "../atoms/select"; // <- ATENÇÃO: Corrigir para "@/components/atoms/select" se usar alias
import {
    Search,
    Grid,
    List,
    ...
    const basicsProducts = [
        {
            ...
            subcategory: "Cimento",
            description:
                "Cimento de alta resistência inicial para estruturas e acabamentos",
            inStock: true,
            rating: 4.9,
            bestseller: true,
        },
        ...
        {
            id: "b25",
            name: "Aditivo Acelerador de Pega 1L",
            price: 22.9,
            image: "https://images.unsplash.com/photo-1635789145651-d5770bc33039?w=800",
            subcategory: "Aditivos",
            description: "Acelera o tempo de pega do concreto",
            inStock: true,
            rating: 4.5,
        },
    ];
                            ...
                            >
                                ...
                                <SelectContent>
                                    {subcategories.map((category) => {
                                        const count =
                                            category.id === "all"
                                                ? basicsProducts.length
                                                : basicsProducts.filter(
                                                      (p) =>
                                                          p.subcategory ===
                                                          category.id
                                                  ).length;

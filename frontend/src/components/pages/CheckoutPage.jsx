...
import { ArrowLeft, CreditCard, Truck, ShoppingBag, CheckCircle } from "lucide-react";
...
export function CheckoutPage({ cartItems = [], onBack, onClearCart }) {
  ...
  const handleFinishOrder = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Pedido realizado com sucesso! Em breve você receberá uma confirmação.");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl mb-2">Finalizar Compra</h1>
            ...
            <Card className="p-6">
              ...
              {shipping === 0 && (
                <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
                  ...
                  <span className="text-green-700">Frete grátis para compras acima de R$ 200,00!</span>
                </div>
              )}
            </Card>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                        paymentMethod === "pix" ? "border-primary" : "border-border"
                      }`}>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      paymentMethod === "boleto" ? "border-primary" : "border-border"
                    }`}>
                      {paymentMethod === "boleto" && <div className="w-3 h-3 bg-primary rounded-full" />}
                    </div>
                    <div>
            ...
            <Card className="p-6 sticky top-24">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-2xl font-bold text-primary">
                  {paymentMethod === "pix" 
                    ? formatPrice((subtotal - (subtotal * 0.05)) + shipping)
                    : formatPrice(total)
                  }
                </span>
              </div>
              ...
              <div className="mt-4 p-3 bg-muted rounded-lg">
                <p className="text-xs text-center text-muted-foreground">
                  Ao finalizar, você concorda com nossos termos e condições de compra
                </p>
              </div>
            </Card>
          </div>

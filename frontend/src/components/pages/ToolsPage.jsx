...
import { Search, Grid, List, ArrowLeft, Wrench, TrendingUp, Star, Filter } from "lucide-react";
...
export function ToolsPage({ onAddToCart, onBack }) {
  ...
  const toolsProducts = [
    // Ferramentas Elétricas
    {
      ...
      description: "Furadeira profissional com controle de velocidade e maleta",
      inStock: true,
      rating: 4.9,
      bestseller: true
    },
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1607586408909-151ba11a12e2?w=800",
      subcategory: "Ferramentas Elétricas",
      description: "Martelete perfurador rotativo com maleta e acessórios",
      inStock: true,
      rating: 4.9
    },
    ...
    // Ferramentas Manuais
    {
      ...
      description: "Kit completo com chaves, alicates e ferramentas diversas",
      inStock: true,
      rating: 4.8,
      bestseller: true
    },
  ...
  const subcategories = [
    ...
    { id: "Ferramentas Elétricas", name: "Ferramentas Elétricas", count: toolsProducts.filter(p => p.subcategory === "Ferramentas Elétricas").length },
    { id: "Ferramentas Manuais", name: "Ferramentas Manuais", count: toolsProducts.filter(p => p.subcategory === "Ferramentas Manuais").length },
    { id: "Ferragens", name: "Ferragens", count: toolsProducts.filter(p => p.subcategory === "Ferragens").length },
    { id: "Segurança", name: "Equipamentos de Segurança", count: toolsProducts.filter(p => p.subcategory === "Segurança").length }
  ];
  ...
  const filteredProducts = toolsProducts.filter(product => {
    ...
    if (priceRange === "50to200") matchesPrice = product.price >= 50 && product.price <= 200;

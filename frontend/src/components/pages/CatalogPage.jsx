        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <div className="min-w-0">
              <h1 className="text-xl md:text-3xl font-bold truncate">Catálogo de Produtos</h1>
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12 md:py-16">
            <p className="text-muted-foreground text-base md:text-lg">Nenhum produto encontrado</p>
            <p className="text-muted-foreground text-sm md:text-base">Tente ajustar os filtros de busca</p>
          </div>
        ) : (
          <div className={
            viewMode === "grid"
            ...
            {filteredProducts.map(product => (
              viewMode === "grid" ? (
                ...
                <div key={product.id} className="bg-white rounded-lg border p-3 md:p-4 flex items-center gap-3 md:gap-4">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 md:gap-4">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-muted-foreground text-xs md:text-sm mb-1 md:mb-2 line-clamp-2">{product.description}</p>
